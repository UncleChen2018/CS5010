...
public class RoomSpaceTest {
  ...
  public void testGetRoomRect() {
      ...
      int[] expected = {3, 3, 7, 7}; // Expected coordinates after adjustment (+1 for end coordinates)
  ...
  public void testGetSpaceInfo() {
      ...
      String expected = "Library, with items: [Book: with damage: 2, in room No. 10]. visible space: [Study]";
